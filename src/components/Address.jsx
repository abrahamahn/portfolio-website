        ...
        <div className="list_inner">
          ...
          <div className="content">
            ...
            <ul>
              ...
              <li>
                <a href="Tel: +82 10 7149 9735">+82 10 7149 9735</a>
              </li>
            </ul>
          </div>{" "}
          {/* End .content */}
      ...
      <li data-aos="fade-right" data-aos-duration="1200" data-aos-delay="100">
        <div className="list_inner">
          ...
          <div className="content">
            ...
            <ul>
              <li>
                <a href="mailto:satmorningrain@gmail.com">satmorningrain@gmail.com</a>
              </li>
              <li>
                <a href="mailto:satmorningrain@gmail.com">abe@cashrollie.com</a>
              </li>
            </ul>
          </div>{" "}
          {/* End .content */}
